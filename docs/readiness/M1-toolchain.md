...
## Identitas- Nama mahasiswa/kelompok:- NIM anggota:- Kelas:- Dosen: Muhaemin Sidiq, S.Pd., M.Pd.- Program Studi: Pendidikan Teknologi Informasi, Institut Pendidikan 
Indonesia- Tanggal:- Commit hash:
## Ringkasan hasil
...
## Readiness decision
Pilih salah satu:- [ ] Belum siap lanjut M2.- [ ] Siap lanjut M2 dengan catatan.- [ ] Siap lanjut M2.
Alasan keputusan:
