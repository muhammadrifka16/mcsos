...
all: build inspect
build: $(KERNEL)
COMMON_CFLAGS := --target=x86_64-unknown-none-elf -std=c17 -ffreestanding -fno-builtin -fno-stack-protector -fno-stack-check -fno-pic -fno-pie -fno
lto -m64 -march=x86-64 -mabi=sysv -mno-red-zone -mno-mmx -mno-sse -mno
sse2 -mcmodel=kernel -Wall -Wextra -Werror -Ikernel/arch/x86_64/include 
Ikernel/include
...
# audit memeriksa undefined symbol dan properti ELF yang harus tetap 
stabil.
audit: inspect panic
>! $(NM) -u $(KERNEL) | grep .
